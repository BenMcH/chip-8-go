...
func (p *Parser) parsePrefixExpression() ast.Expression {
	prefix := &ast.PrefixExpression{Token: p.curToken, Operator: p.curToken.Literal}
...
func (p *Parser) parseInfixExpression(left ast.Expression) ast.Expression {
	infix := &ast.InfixExpression{Token: p.curToken, Operator: p.curToken.Literal, Left: left}
...
func (p *Parser) parseLetStatement() *ast.LetStatement {
	...
	// TODO: Skipping the tokens until we encounter a semicolon
